...
#[doc(hidden)]
impl<'a, T: ?Sized, Rs, Rq> From<inner::MutexGuard<'a, T, AtomicBool, RelaxWait<Rs>, RelaxWait<Rq>>>
    for MutexGuard<'a, T, Rs, Rq>
{
    fn from(inner: inner::MutexGuard<'a, T, AtomicBool, RelaxWait<Rs>, RelaxWait<Rq>>) -> Self {
        Self { inner }
    }
}
