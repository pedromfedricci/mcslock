...
//! having threads spin and/or park on local memory locations. The main properties
...
//!
//! [`raw::MutexNode`]: raw::MutexNode
//! [`raw::LocalMutexNode`]: raw::LocalMutexNode
//! [`parking::raw::Mutex`]: parking::raw::Mutex
//! [`parking::raw::LocalMutexNode`]: parking::raw::LocalMutexNode
//! [`thread_local_node!`]: crate::thread_local_node
//! [`thread_local_parking_node!`]: crate::thread_local_parking_node
//!
