...
//! [`std::sync::Mutex`] and [`parking_lot::Mutex`] . These implementations will
...
//! APIs require a static reference to a [`raw::LocalMutexNode`] key. Keys must
//! be generated by the [`thread_local_node!`] macro. This feature **is not**
//! `no_std` compatible.
//!
//! ### barging
//!
...
//! [`barging::Mutex`]. Aliases are provided by the [`barging::lock_api`]
//! (`no_std`) module.
//!
//! ## Related projects
//!
